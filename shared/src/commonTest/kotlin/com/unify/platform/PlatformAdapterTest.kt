...
class PlatformAdapterTest {
    ...
    @Test
    fun testAndroidPlatformAdapter() =
        runTest {
            // 测试Android平台适配器
    ...
    @Test
    fun testDesktopPlatformAdapter() =
        runTest {
            // 测试Desktop平台适配器
    ...
    @Test
    fun testHarmonyOSPlatformAdapter() =
        runTest {
            // 测试HarmonyOS平台适配器
    ...
    @Test
    fun testMiniAppPlatformAdapter() =
        runTest {
            // 测试小程序平台适配器
    ...
    class AndroidPlatformAdapter : PlatformAdapter {
        ...
        override fun supportsFeature(feature: String): Boolean = feature in listOf("NOTIFICATION", "BACKGROUND_TASK", "CAMERA", "GPS")
    ...
    class IOSPlatformAdapter : PlatformAdapter {
        ...
        override fun supportsFeature(feature: String): Boolean = feature in listOf("BIOMETRIC", "PUSH_NOTIFICATION", "CAMERA", "GPS")
    ...
    class WebPlatformAdapter : PlatformAdapter {
        ...
        override fun supportsFeature(feature: String): Boolean = feature in listOf("LOCAL_STORAGE", "GEOLOCATION", "CAMERA")
    ...
    class DesktopPlatformAdapter : PlatformAdapter {
        ...
        override fun supportsFeature(feature: String): Boolean = feature in listOf("FILE_SYSTEM", "SYSTEM_TRAY", "MULTI_WINDOW")
    ...
    class HarmonyOSPlatformAdapter : PlatformAdapter {
        ...
        override fun supportsFeature(feature: String): Boolean = feature in listOf("DISTRIBUTED", "SUPER_DEVICE", "ARKUI")
    ...
    class MiniAppPlatformAdapter : PlatformAdapter {
        ...
        override fun supportsFeature(feature: String): Boolean = feature in listOf("WECHAT_API", "PAYMENT", "SHARE")
    ...
    class WatchPlatformAdapter : PlatformAdapter {
        ...
        override fun supportsFeature(feature: String): Boolean = feature in listOf("HEALTH", "FITNESS", "HEART_RATE")
    ...
    class TVPlatformAdapter : PlatformAdapter {
        ...
        override fun supportsFeature(feature: String): Boolean = feature in listOf("REMOTE_CONTROL", "4K_DISPLAY", "HDMI")
