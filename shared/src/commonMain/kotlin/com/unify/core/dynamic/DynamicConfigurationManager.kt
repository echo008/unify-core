...
interface DynamicConfigurationManager {
    ...
    // 配置值操作
    suspend fun getConfigValue(configId: String, key: String): ConfigValue?
    suspend fun setConfigValue(configId: String, key: String, value: ConfigValue): Boolean
    suspend fun removeConfigValue(configId: String, key: String): Boolean
    
    // 批量操作
    suspend fun batchUpdateConfigurations(updates: Map<String, Map<String, ConfigValue>>): Boolean
    suspend fun mergeConfigurations(baseConfigId: String, overrideConfigId: String): DynamicConfiguration?
    
    // 配置验证
    suspend fun validateConfiguration(config: DynamicConfiguration): ConfigValidationResult
    suspend fun validateConfigValue(configId: String, key: String, value: ConfigValue): Boolean
    
    // 配置监听
    fun observeConfiguration(configId: String): Flow<DynamicConfiguration?>
    fun observeConfigurationChanges(): Flow<ConfigChangeEvent>
    fun observeConfigValue(configId: String, key: String): Flow<ConfigValue?>
    
    // 配置备份和恢复
    suspend fun backupConfiguration(configId: String): String?
    suspend fun restoreConfiguration(configId: String, backupData: String): Boolean
...
class DynamicConfigurationManagerImpl(
    ...
    override suspend fun saveConfiguration(config: DynamicConfiguration): Boolean {
        return try {
            ...
            if (success) {
                ...
                val changeEvent = ConfigChangeEvent(
                    configId = config.id,
    ...
    override suspend fun getConfigValue(configId: String, key: String): ConfigValue? {
        val config = loadConfiguration(configId)
        return config?.values?.get(key)
    }
    
    override suspend fun setConfigValue(configId: String, key: String, value: ConfigValue): Boolean {
    ...
    override suspend fun removeConfigValue(configId: String, key: String): Boolean {
        val config = loadConfiguration(configId) ?: return false
    ...
    override suspend fun mergeConfigurations(baseConfigId: String, overrideConfigId: String): DynamicConfiguration? {
    ...
    override suspend fun validateConfigValue(configId: String, key: String, value: ConfigValue): Boolean {
        val config = loadConfiguration(configId) ?: return false
    ...
    override fun observeConfigValue(configId: String, key: String): Flow<ConfigValue?> {
    ...
    override suspend fun restoreConfiguration(configId: String, backupData: String): Boolean {
        return try {
    ...
    override suspend fun importConfigurations(data: String): Boolean {
        return try {
            ...
            val configurations = Json.decodeFromJsonElement<List<DynamicConfiguration>>(
    ...
    private fun validateRule(rule: ValidationRule, value: ConfigValue?): String? {
