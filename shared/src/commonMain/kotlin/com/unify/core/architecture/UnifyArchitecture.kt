...
object UnifyArchitecture {
    ...
    fun unregisterComponent(componentId: String): Boolean {
        ...
        // 检查是否有其他组件依赖此组件
        val hasDependents = _dependencies.value.values.any { deps ->
     ...
     * 添加依赖关系
     */
    fun addDependency(componentId: String, dependencyId: String): Boolean {
        // 检查组件是否存在
     ...
     * 移除依赖关系
     */
    fun removeDependency(componentId: String, dependencyId: String): Boolean {
        val currentDeps = _dependencies.value.toMutableMap()
     ...
     * 检查循环依赖
     */
    private fun hasCircularDependency(componentId: String, dependencyId: String): Boolean {
     ...
     * 更新组件状态
     */
    private fun updateComponentState(componentId: String, newState: ComponentState) {
        val currentComponents = _components.value.toMutableMap()
