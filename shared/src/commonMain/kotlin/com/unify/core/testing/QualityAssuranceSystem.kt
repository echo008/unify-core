...
class QualityAssuranceSystemImpl(
    ...
    companion object {
        ...
        // 默认阈值
        private fun getDefaultThresholds(): Map<String, Double> = mapOf(
            "code_quality" to 85.0,
            "test_coverage" to 80.0,
            "performance" to 90.0,
            "security" to 95.0,
    ...
    override suspend fun runQualityChecks(): QualityReport {
        ...
        config.enabledChecks.forEach { category ->
            try {
                ...
                checkResults.add(QualityCheckResult(
    ...
    private fun initializeQualityGateRules() {
        qualityGateRules.addAll(listOf(
            QualityGateRule(
    ...
    private fun getMetricValue(metrics: QualityMetrics, metricName: String): Double {
    ...
    private fun evaluateRule(value: Double, operator: ComparisonOperator, threshold: Double): Boolean {
