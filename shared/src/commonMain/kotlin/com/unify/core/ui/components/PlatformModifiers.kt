...
@androidx.compose.runtime.Composable
expect fun Modifier.platformLongClickable(
    enabled: Boolean = true,
    onLongClick: () -> Unit,
): Modifier

@androidx.compose.runtime.Composable
expect fun Modifier.platformShadow(
    elevation: Dp,
...
@androidx.compose.runtime.Composable
expect fun Modifier.platformBorder(
    width: Dp,
    color: Color,
    shape: Shape = RoundedCornerShape(0.dp),
): Modifier
...
@androidx.compose.runtime.Composable
expect fun Modifier.platformPadding(
    horizontal: Dp = 0.dp,
    vertical: Dp = 0.dp,
): Modifier

@androidx.compose.runtime.Composable
expect fun Modifier.platformSize(
    width: Dp,
    height: Dp,
): Modifier
...
@androidx.compose.runtime.Composable
expect fun Modifier.platformAccessibility(
