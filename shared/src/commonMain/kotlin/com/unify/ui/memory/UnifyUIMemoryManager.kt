...
object UnifyUIMemoryManager {
     ...
     * 计算内存压力
     */
    private fun calculateMemoryPressure(used: Long, total: Long): MemoryPressure {
    ...
    enum class CacheType {
        COMPONENT, IMAGE, DATA, ALL
    }
    
    /**
     * 缓存组件
     */
    fun cacheComponent(key: String, component: Any) {
     ...
     * 缓存图片
     */
    fun cacheImage(key: String, image: Any) {
    ...
    enum class SuggestionType {
        CLEAR_CACHE, OPTIMIZE_IMAGES, REDUCE_CACHE_SIZE, GARBAGE_COLLECT
    }
