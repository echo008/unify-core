...
class UnifyDeviceManagerEnhanced {
    ...
    private fun getStorageHealth(): HealthMetric {
        ...
        return HealthMetric(
            ...
            status = if (usage.usagePercentage < STORAGE_WARNING_THRESHOLD) 
...
enum class IssueType {
    PERFORMANCE, MEMORY, THERMAL, BATTERY, STORAGE, NETWORK, SENSOR
}
...
enum class OptimizationType {
    PERFORMANCE, MEMORY, BATTERY, STORAGE, THERMAL, NETWORK
}
