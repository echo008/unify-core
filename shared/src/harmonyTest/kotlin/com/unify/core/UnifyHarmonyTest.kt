...
class UnifyHarmonyTest {
    ...
    @Test
    fun testHarmonyPlatformAdapters() =
        runTest {
    ...
    @Test
    fun testHarmonyDistributedFeatures() =
        runTest {
            // 测试HarmonyOS分布式特性
