...
class UnifyDesktopTest {
    ...
    @Test
    fun testDesktopDataManager() = runTest {
        // 测试文件存储
    ...
    @Test
    fun testDesktopPlatformAdapters() = runTest {
    ...
    @Test
    fun testDesktopSystemInfo() = runTest {
    ...
    @Test
    fun testDesktopFileSystem() = runTest {
    ...
    @Test
    fun testDesktopNetworkInfo() = runTest {
    ...
    @Test
    fun testDesktopMemoryInfo() = runTest {
    ...
    @Test
    fun testDesktopDisplayInfo() = runTest {
    ...
    @Test
    fun testDesktopFileOperations() = runTest {
    ...
    @Test
    fun testDesktopDataTypes() = runTest {
        // 测试各种数据类型存储
