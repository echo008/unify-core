...
object HarmonyMiniAppUtils {
     ...
     * 启动原子化服务
     */
    private fun launchAtomicService(
        appId: String,
     ...
     * 启动分布式应用
     */
    private fun launchDistributedApp(
        appId: String,
        params: Map<String, String>,
    ) {
        try {
     ...
     * 启动通用HarmonyOS应用
     */
    private fun launchGenericHarmonyApp(
        appId: String,
        params: Map<String, String>,
    ) {
        try {
    ...
    fun getSupportedApis(appId: String): List<String> {
        return when {
            appId.startsWith("harmony_atomic_") ->
                listOf(
                    "harmony.atomicService",
                    "harmony.want",
                    "harmony.context",
                    "harmony.arkui",
                    "harmony.account",
            ...
            appId.startsWith("harmony_card_") ->
                listOf(
                    "harmony.formExtension",
                    "harmony.formProvider",
                    "harmony.formManager",
                    "harmony.dataBinding",
                    "harmony.cardInteraction",
                )
            appId.startsWith("harmony_distributed_") ->
                listOf(
                    "harmony.deviceManager",
                    "harmony.distributedData",
                    "harmony.remoteAbility",
                    "harmony.continuation",
                    "harmony.distributedObject",
                    "harmony.distributedFile",
                )
            else ->
                listOf(
                    "harmony.basic",
     ...
     * 注册卡片提供方
     */
    fun registerFormProvider(
        formId: String,
        formConfig: HarmonyFormConfig,
    ): Boolean {
        return try {
