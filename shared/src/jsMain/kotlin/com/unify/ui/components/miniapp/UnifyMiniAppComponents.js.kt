...
object WebMiniAppUtils {
     ...
     * 启动PWA应用
     */
    private fun launchPWA(appId: String, params: Map<String, String>) {
        try {
     ...
     * 启动WebAssembly应用
     */
    private fun launchWebAssemblyApp(appId: String, params: Map<String, String>) {
        try {
     ...
     * 启动Service Worker应用
     */
    private fun launchServiceWorkerApp(appId: String, params: Map<String, String>) {
        try {
     ...
     * 启动Web Components应用
     */
    private fun launchWebComponentsApp(appId: String, params: Map<String, String>) {
        try {
     ...
     * 启动通用Web应用
     */
    private fun launchGenericWebApp(appId: String, params: Map<String, String>) {
        try {
