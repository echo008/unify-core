...
class UnifyIOSTest {
    ...
    @Test
    fun testIOSDataManager() = runTest {
        // 测试NSUserDefaults存储
    ...
    @Test
    fun testIOSPlatformAdapters() = runTest {
    ...
    @Test
    fun testIOSDeviceModel() = runTest {
    ...
    @Test
    fun testIOSBatteryInfo() = runTest {
    ...
    @Test
    fun testIOSNetworkInfo() = runTest {
    ...
    @Test
    fun testIOSStorageInfo() = runTest {
    ...
    @Test
    fun testIOSPermissions() = runTest {
    ...
    @Test
    fun testIOSDisplayInfo() = runTest {
