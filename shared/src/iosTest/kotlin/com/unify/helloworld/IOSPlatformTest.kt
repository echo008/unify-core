...
class IOSPlatformTest {
    ...
    fun testIOSSpecificFeatures() {
        ...
        assertTrue("iOS应该支持Face ID/Touch ID", 
            platformInfo.supportedFeatures.contains("biometric"))
        assertTrue("iOS应该支持Core Motion", 
    ...
    fun testIOSDeviceInfo() {
        ...
        val isValidDevice = validDeviceTypes.any { type ->
    ...
    fun testIOSSensorInfo() {
        ...
        val hasSomeSensors = iosSensors.any { sensor ->
    ...
    fun testIOSSecurityFeatures() {
        ...
        // iOS安全特性测试
        assertTrue("iOS应该支持生物识别", 
            platformInfo.supportedFeatures.contains("biometric"))
        assertTrue("iOS应该支持Keychain", 
            platformInfo.supportedFeatures.contains("keychain"))
        assertTrue("iOS应该支持App Transport Security", 
